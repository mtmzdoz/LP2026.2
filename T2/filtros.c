...
static int exposicion = 100;
static int rotacionDerecha = 1;

/*
***
Parametro 1: int (porcentaje de exposicion)
***
Retorno: None
***
Actualiza la variable estatica global del porcentaje de exposicion
*/
void porcentajeExposicion(int porcentaje){ 
    exposicion = porcentaje; 
}

/*
***
Parametro 1: int (direccion de rotacion)
***
Retorno: None
***
Actualiza la variable estatica global para la direccion de rotacion
*/
void dirRotacion(int rotacion){ 
    rotacionDerecha = rotacion; 
}
...
void filtro_expos(struct Lienzo *l){
    ...
    for (int y = 0; y < l->h; y++){
        for (int x = 0; x < l->w; x++){
            Pixel *pixel = l->matriz[y][x];
            int r = (pixel->r * exposicion) / 100;
            int g = (pixel->g * exposicion) / 100;
            int b = (pixel->b * exposicion) / 100;
