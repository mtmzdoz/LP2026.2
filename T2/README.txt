...
Instrucciones
Antes de ejecutar, revisar  que exista una carpeta llamada "img" en el mismo directorio. Para que el comando SAVE funcione correctamente, debe existir una carpeta llamada "img" en el mismo directorio donde se encuentra el ejecutable. De lo contrario, los archivos .ppm no podran generarse
...
Consideraciones
  ...
  3. En el makefile se agrego "rm -f img/*.ppm" que elimina los .ppm generados en la carpeta img, esto para dejar "limpio" cada vez que se hace makeclean. En caso de que se ejecute un archivo y luego otro, el archivo .ppm se sobreescribira
